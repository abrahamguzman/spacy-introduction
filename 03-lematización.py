...
# Agrupa palabras y su lema
tokens_lemas_df = pd.DataFrame(lista_tokens_lemmas, columns=['Token','Lemma'])
print(tokens_lemas_df.head(15))

# Agrupa lemas por cantidad
agrupado = tokens_lemas_df.groupby('Lemma')['Lemma'].count()
agrupado.sort_values(ascending=False, inplace=True)
print(agrupado.head(15))

# Genera un json por Lema y cantidad
agrupado.to_json('lema_cantidad.json')